...
$('ul>li').click(function(e){
	...
	$(this).find('img:odd').css('display','block')
	$(this).find('img:even').css('display','none')
	$(this).siblings('li').find('img:odd').css('display','none')
	$(this).siblings('li').find('img:even').css('display','block')

	let str = $(this).find('span').text()
		$('._description').html(str)
})
